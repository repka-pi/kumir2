...
function(kumir2_add_launcher)    
    cmake_parse_arguments(PARSED_ARGS "" "NAME;SPLASHSCREEN;CONFIGURATION;WINDOW_ICON;APP_ICON_NAME;X_ICONS_DIR;WIN_ICONS_DIR;X_NAME;X_NAME_ru;X_CATEGORIES;X_EXEC;APP_NAME;APP_NAME_ru;VENDOR_NAME;VENDOR_NAME_ru;APP_VERSION;APP_LICENSE;APP_LICENSE_ru;APP_ABOUT;APP_ABOUT_ru" "" ${ARGN})
    ...
    if(KUMIR2_XDG_APPLICATIONS_DIR AND PARSED_ARGS_X_NAME)
        ...
        if(PARSED_ARGS_X_EXEC)
            file(APPEND ${DESKTOP_FILE} "Exec=${PARSED_ARGS_X_EXEC}\n")
        else()
